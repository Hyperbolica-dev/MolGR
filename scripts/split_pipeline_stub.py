...
MODULE_TO_PACKAGE_INIT = (
    (CORE_ROOT / "pipeline.pyi", PIPELINE_ROOT / "__init__.pyi"),
    (CORE_ROOT / "dev.pyi", DEV_ROOT / "__init__.pyi"),
    (DEV_ROOT / "pipeline.pyi", DEV_PIPELINE_ROOT / "__init__.pyi"),
    (DEV_ROOT / "stages.pyi", DEV_STAGES_ROOT / "__init__.pyi"),
)
